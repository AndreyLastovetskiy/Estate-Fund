...
$select_flat_idconst = $select_struct['id_const'];
...
<body>
    <h2>Согласование сделки на аренду - <?= $select_struct['name']; ?></h2>
    <form action="./vendor/approve-struct.php?id=<?= $id_flat; ?>" method="post">
        ...
        <input type="hidden" name="id_struct" value="<?= $id_flat; ?>">
