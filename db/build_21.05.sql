...
--
-- Хост: 127.0.0.1
-- Время создания: Май 21 2023 г., 16:52
...
--
-- Структура таблицы `approve_struct`
--

CREATE TABLE `approve_struct` (
  `id` int(11) NOT NULL,
  `id_owner` int(11) NOT NULL,
  `id_client` int(11) NOT NULL,
  `id_const` int(11) NOT NULL,
...
(6, 3, 'Номер 1', '<p>Номер 1</p>', 102, '3500', 'upload/flat/1684680623apC0ck5XNQg.jpg', 1);
...
INSERT INTO `structure` (`id`, `id_const`, `name`, `descr`, `square_meter`, `price`, `struct_img`, `free`) VALUES
(1, 3, 'Баня 1', '<p>Баня 1</p>', 20, '5000', 'upload/structure/1684678499uWh5l2JaHqg.jpg', 0);
...
--
-- Индексы таблицы `approve_struct`
--
ALTER TABLE `approve_struct`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `approve_struct`
--
ALTER TABLE `approve_struct`
